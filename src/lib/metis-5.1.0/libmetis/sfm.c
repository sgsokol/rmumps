...
void FM_2WayNodeRefine2Sided(ctrl_t *ctrl, graph_t *graph, idx_t niter)
{
  ...
  IFSET(ctrl->dbglvl, METIS_DBG_REFINE,
    rcpp_warning("Partitions-N2: [%6"PRIDX" %6"PRIDX"] Nv-Nb[%6"PRIDX" %6"PRIDX"]. ISep: %6"PRIDX"\n", pwgts[0], pwgts[1], graph->nvtxs, graph->nbnd, graph->mincut));
  ...
  for (pass=0; pass<niter; pass++) {
    ...
    for (nswaps=0; nswaps<nvtxs; nswaps++) {
      ...
      ***********************************************************/
      ...
      IFSET(ctrl->dbglvl, METIS_DBG_MOVEINFO,
            rcpp_warning("Moved %6"PRIDX" to %3"PRIDX", Gain: %5"PRIDX" [%5"PRIDX"] [%4"PRIDX" %4"PRIDX"] \t[%5"PRIDX" %5"PRIDX" %5"PRIDX"]\n", higain, to, g[to], g[other], vwgt[u[to]], vwgt[u[other]], pwgts[0], pwgts[1], pwgts[2]));
    ...
    *****************************************************************/
    ...
    IFSET(ctrl->dbglvl, METIS_DBG_REFINE,
      rcpp_warning("\tMinimum sep: %6"PRIDX" at %5"PRIDX", PWGTS: [%6"PRIDX" %6"PRIDX"], NBND: %6"PRIDX"\n", mincut, mincutorder, pwgts[0], pwgts[1], nbnd));
...
void FM_2WayNodeRefine1Sided(ctrl_t *ctrl, graph_t *graph, idx_t niter)
{
  ...
  IFSET(ctrl->dbglvl, METIS_DBG_REFINE,
    rcpp_warning("Partitions-N1: [%6"PRIDX" %6"PRIDX"] Nv-Nb[%6"PRIDX" %6"PRIDX"]. ISep: %6"PRIDX"\n", pwgts[0], pwgts[1], graph->nvtxs, graph->nbnd, graph->mincut));
    ...
    *******************************************************/
    ...
    for (nswaps=0; nswaps<nvtxs; nswaps++) {
      ...
      ***********************************************************/
      ...
      IFSET(ctrl->dbglvl, METIS_DBG_MOVEINFO,
            rcpp_warning("Moved %6"PRIDX" to %3"PRIDX", Gain: %5"PRIDX" [%5"PRIDX"] \t[%5"PRIDX" %5"PRIDX" %5"PRIDX"] [%3"PRIDX" %2"PRIDX"]\n", 
...
void FM_2WayNodeBalance(ctrl_t *ctrl, graph_t *graph)
{
  ...
  IFSET(ctrl->dbglvl, METIS_DBG_REFINE,
    rcpp_warning("Partitions: [%6"PRIDX" %6"PRIDX"] Nv-Nb[%6"PRIDX" %6"PRIDX"]. ISep: %6"PRIDX" [B]\n", pwgts[0], pwgts[1], graph->nvtxs, graph->nbnd, graph->mincut));
  ...
  *******************************************************/
  for (nswaps=0; nswaps<nvtxs; nswaps++) {
    ...
    IFSET(ctrl->dbglvl, METIS_DBG_MOVEINFO,
          rcpp_warning("Moved %6"PRIDX" to %3"PRIDX", Gain: %3"PRIDX", \t[%5"PRIDX" %5"PRIDX" %5"PRIDX"]\n", higain, to, vwgt[higain]-rinfo[higain].edegrees[other], pwgts[0], pwgts[1], pwgts[2]));
  ...
  IFSET(ctrl->dbglvl, METIS_DBG_REFINE,
    rcpp_warning("\tBalanced sep: %6"PRIDX" at %4"PRIDX", PWGTS: [%6"PRIDX" %6"PRIDX"], NBND: %6"PRIDX"\n", pwgts[2], nswaps, pwgts[0], pwgts[1], nbnd));
